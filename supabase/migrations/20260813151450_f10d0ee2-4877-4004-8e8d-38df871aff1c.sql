...
create index deposits_owner_idx on public.deposits (owner);
...
create index withdrawals_owner_idx on public.withdrawals (owner);
...
grant select, insert, update, delete on public.bans to anon, authenticated;
...
grant select, insert, update, delete on public.deposits to anon, authenticated;
...
grant select, insert, update, delete on public.review_requests to anon, authenticated;
